...
/** Pins the Kotlin feature-extraction + scoring contract against probabilities the Python
 * trainer computed on the same committed, dequantised blob - catches silent featurisation drift. */
